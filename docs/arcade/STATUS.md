...
- Six-course Grand Tour, three laps per course, labeled bot practice and private two-driver online racing. Rules v4 adds direct proportional touch/controller steering, progressive keyboard turn-in, faster release/countersteer and four seeded practice rival styles with varying cars, lines, pace and boost choices. Placement still uses validated course progress. Frontend and Railway authority must both be updated.
