  ...
  return <div className={s.os} style={{ "--accent": theme.color }}>
    ...
    <div className={s.desktop}>
      ...
      <main className={s.main}>
        ...
        <div className={s.invite}><div><b>NEW / WEN LAMBO</b><span>Finally rich. Still can’t drive. Five cars, Bike Tyson, six courses, drift-to-boost racing and a private two-player cup.</span></div><Link className={s.darkButton} href="/os/lambo">PLAY WEN LAMBO ↗</Link></div>
