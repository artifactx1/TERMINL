...
try{
  ...
  console.log(JSON.stringify({ok:true,realMultiTouch:true,boostWithOneThumb:true,reverse:true,slideSteering:true,cancelAndPauseRelease:true,observedMoves:observed,layouts:[390,844,320,568],errors}));
