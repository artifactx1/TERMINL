...
try{
 ...
 await advance(10,{bank:true});await advance(10,{});assert.ok(Number(await page.locator('canvas').getAttribute('data-score'))>0);await page.screenshot({path:'artifacts/after-hours/mall-combo.png'});
