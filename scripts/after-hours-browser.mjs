...
try{
 ...
 for(let batch=0;batch<20;batch++)await advance(100,{},100);await advance(8,{});assert.equal(await page.locator('canvas').getAttribute('data-phase'),'finished');await page.getByRole('heading',{name:'ONE MORE LINE?'}).waitFor();
