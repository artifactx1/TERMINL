...
export default function RumblePage({assetLabEnabled}){return <><Head><title>REKT RUMBLE — TERMINL Arcade Preview</title><meta name="robots" content="noindex" /></Head><Rumble assetLabEnabled={assetLabEnabled} /></>;}
