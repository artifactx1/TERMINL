...
/* Same ids ArtifactX whitelists. Anything not listed is hidden — Reown
 * otherwise surfaces a long tail of "recommended" wallets by default. */
...
/* The modal follows the page: Robinhood yellow on near-black, square corners,
...
export const getAppKit = () => {
  ...
  if (!kit) {
    kit = createAppKit({
      ...
      includeWalletIds: [METAMASK, COINBASE],
