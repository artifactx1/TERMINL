...
export const MOVES = Object.freeze({max:movesFor('max'),diamond:movesFor('diamond')});
...
function applyContact(s,c) {
  ...
  if(kind==='armor') {b.hp=Math.max(0,b.hp-Math.floor(m.damage*.5));b.action.armored=true;emit(s,'armor',1-slot,'DIAMOND ARMOR');return;}
