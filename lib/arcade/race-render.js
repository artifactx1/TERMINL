...
export const RACE_ART_MANIFEST=Object.freeze({version:1,vehicles:['comet','spectre'],tracks:Object.keys(TRACKS),source:'original-code-native',nativeCarPixels:[66,42],trackPixels:[1168,864],maxTrackCacheBytes:8073216,liveEffects:['steering','boost-exhaust','drift-smoke','tire-marks','ghost-recovery','checkpoint','minimap']});
