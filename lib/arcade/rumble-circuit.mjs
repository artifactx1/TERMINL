...
export function circuitInput(state,c){let input=botInput(state,1);const pause=Math.max(0,110-c.index*22);if(state.tick%240<pause)input&=~(16|32|64|512|1024);if(c.index<2&&state.tick%100<35)input&=~128;return input;}
