...
export const RUMBLE_ROSTER=Object.freeze([
  ...
  {id:'mia',name:'MEV Mia',portrait:'mev-mia',style:'FAST FEET / PRESSURE',line:'One good trade. Nine feet of receipts.',tip:'The fastest fighter, with lighter hits. Check with Priority Tap, mix low attacks and throws, then dash out before a counter.'},
