...
/** Complete generated vehicles include their own tires: never add a second wheel rig. */
export function drawVehicleArt(c,id,{x,y,width,height=Infinity,view='rear'}={}){
  ...
  c.drawImage(image,sx,sy,sw,sh,x-w/2,y-h,w,h);c.restore();return true;
}
