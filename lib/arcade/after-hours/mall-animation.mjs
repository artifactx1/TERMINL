...
export function sampleSkatePose(s,cameraYaw){
 ...
 let frame=SKATE_CLIPS.coast,bodyLift=0,boardPitch=p.grounded?Math.atan(p.rampSlope||0):0,boardRoll=0,boardYaw=0,somersault=0;
 ...
 return {frame:facingFrame(bodyYaw,cameraYaw,frame),rearFrame:frame,bodyYaw,bodyLift,boardPitch,boardRoll,boardYaw,somersault,lean:(p.steer||0)*-.1,flipping:trickActive&&p.trickType==='flip'&&age<duration*.8,landing,bail:p.bail||0};
}
