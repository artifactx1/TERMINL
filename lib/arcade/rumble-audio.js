...
export const SOUND_CUES=Object.freeze(['ui','light','heavy','block','armor','throw','tech','jump','land','dash','special','super','warning','fight','win','loss','finishReady','finisherStart','finisherImpact']);
...
export class RumbleAudio {
  ...
  audition(type){
    ...
    switch(type){
      ...
      case 'finishReady':this.tone(130,.5,'sawtooth',.12,t,60);this.tone(390,.4,'triangle',.2,t+.18);break;
      case 'finisherStart':this.tone(90,.7,'sawtooth',.14,t,700);this.noise(.35,.25,900,t+.25);break;
      case 'finisherImpact':this.tone(100,.45,'sine',.8,t,25);this.noise(.35,.5,700);this.tone(240,.2,'triangle',.18,t+.08);break;
