 ...
 */
import {trackGeometry,nearestRoad,roadAt,angleDelta,VEHICLES} from './race-sim.mjs';
...
export function drawPerspectiveRace(ctx,state,{width,height,slot=0,reducedMotion=false,quality='high'}={}){
  ...
  const gate=g.gates[index],left=edge(gate,-1,g.width/2+18),right=edge(gate,1,g.width/2+18);
